...
q_1, I_1, sI_1 = load_xye('../dl_1-25/xrr/transform_data/DD205_3.xye')
q_2, I_2, sI_2 = load_xye('../dl_1-25-2/xrr/transform_data/DD205_12.xye')
...
ax.plot(q_2, I_2*2, alpha=0.8, marker='None', label='$2 \cdot$ DL-1.25%-2')
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('$\mathit{q_z} \, / \, nm^{-1}$')
ax.set_ylabel('$\mathit{R}$')
ax.set_xlim(0.07, 4.1)
