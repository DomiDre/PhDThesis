...
modelRef.setParam("i0", 0.9000508319778069,  minVal = 0, maxVal = 1.5, vary = True)
modelRef.setParam("roughnessSubstrate", 0.0,  minVal = 0.0, maxVal = 50, vary = True)
modelRef.setParam("roughnessPlus1", 8.389686853495546,  minVal = 0.0, maxVal = 50, vary = True)
modelRef.setParam("roughnessPlus2", 0.5,  minVal = 0.0, maxVal = 50, vary = True)
modelRef.setParam("packingDensity1", 0.649,  minVal = 0.0, maxVal = 1.0, vary = True)
modelRef.setParam("packingDensity2", 0.1290422389361885,  minVal = 0.0, maxVal = 1.0, vary = True)
modelRef.setParam("coverage", 0.396,  minVal = 0.0, maxVal = 1.0, vary = True)
modelRef.setParam("spacerThickness", 30.900000000000002,  minVal = 0, maxVal = 50, vary = True)

modelRef.setParam("magSldCore", 5.3999999999999994e-08,  minVal = 0.0, maxVal = 2e-06, vary = True)
