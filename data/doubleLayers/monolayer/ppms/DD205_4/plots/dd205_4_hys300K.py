...
datfile = '../rawdata/DD205_4_HYST_100OE_300K.DAT'
pngfilename = 'DD205_4_HYST_100OE_300K.png'

PPMS = PPMS()
PPMS.load(datfile)
B, M = PPMS.get_BM()
PPMS.fit_diamagnetism(6, 9, show=True)
chi = PPMS.get_diamagnetic_slope()
PPMS.export('DD205_8_extracted.dat')
# M -= chi*B
M *= 1000
...
ax.plot(B, M, linestyle='None', marker='.', zorder=1, label='DD205.4')
