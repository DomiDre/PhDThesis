...
for temperature in ['5', '10', '20', '50', '300']:
  datfile = '../rawdata/DD205_4_HYST_100OE_'+temperature+'K.DAT'
  datfileCologne = './DD205_4_KOELNPPMS_HYST_100OE_'+temperature+'K.DAT'
  pngfilename = 'compare'+temperature+'K.png'
  ...
  B, M = ppms.get_BM()
  M *= 1000
  ax.plot(B, M, linestyle='None', marker='.', markersize=1, zorder=1, alpha=0.5, label='Julich')
