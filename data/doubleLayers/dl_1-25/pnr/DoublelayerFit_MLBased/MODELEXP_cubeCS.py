...
dataRef.loadFromFile('../mftFiles/DD205_3_5K_10mT_u.mft', ['p'])
dataRef.loadFromFile('../mftFiles/DD205_3_5K_10mT_d.mft', ['m'])
...
modelRef.setParam("thicknessPMMA", 653.0,  minVal = 0, maxVal = 1000, vary = True)
...
modelRef.setParam("roughnessShellCube1", 15.100000000000001,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessCubeShell1", 26.6,  minVal = 0, maxVal = 100, vary = True)
