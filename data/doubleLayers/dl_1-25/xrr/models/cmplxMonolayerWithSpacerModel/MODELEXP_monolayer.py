...
modelRef.setParam("roughnessShellCube", 17.6,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessCubeShell", 5.4,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessShellAir", 9.200000000000001,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessPMMA", 9.200000000000001,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("packingDensity1", 0.553,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("packingDensity2", 0.553,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("thicknessShellTop", 32.4,  minVal = 0, maxVal = 100, vary = True)
...
modelRef.setParam("thicknessPMMA", 200.0,  minVal = 0, maxVal = 1000, vary = True)
modelRef.setParam("bg", 9.450000000000001e-07,  minVal = 0, maxVal = 5e-06, vary = True)
