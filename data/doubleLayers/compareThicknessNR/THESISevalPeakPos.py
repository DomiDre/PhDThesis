...
savefile = chapter+'_NR_MinimaPositions'
...
ax.plot(idx_2_5, q_2_5, color='#7F0128',marker='x', ls='None', label='DL-2.5%', zorder=1)

ax.plot(lin_range, linear(p_0_25, lin_range), color='black', ls='-', marker='None', zorder=0)
...
#   )
ax.text(0.4, 0.21, '$d_\mathrm{sample}$'+f' = {L_0_25} nm',
  horizontalalignment='left',
  verticalalignment='bottom',
  color=color_variant('#EE292F', -100),
  transform=ax.transAxes
  )
ax.text(0.4, 0.12, '$d_\mathrm{sample}$'+f' = {L_1_25}({sigL_1_25}) nm',
  horizontalalignment='left',
  verticalalignment='bottom',
...
ax.text(0.4, 0.03, '$d_\mathrm{sample}$'+f' = {L_2_5}({sigL_2_5}) nm',
  horizontalalignment='left',
  verticalalignment='bottom',
  color=color_variant('#7F0128', -100),
  transform=ax.transAxes
  )
