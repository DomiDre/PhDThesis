...
projI_min, projI_max = 1.5e-2, 9e-2#5e-3, 5e-2
...
qy_sat_p, qz_sat_p, data_sat_p, I_sat_p, sI_sat_p = load_files('./0rawdata/020', np.arange(455, 502, 2))
qy_sat_m, qz_sat_m, data_sat_m, I_sat_m, sI_sat_m = load_files('./0rawdata/020', np.arange(456, 502, 2))
...
ax.set_ylim(-0.5, 0.5)
ax2.set_ylim(projI_min, projI_max)
ax2.legend(loc='bottom center', fontsize=10)
