...
modelRef.setParam("particleSize1", 35.36,  minVal = 0, maxVal = 80, vary = False)
modelRef.setParam("particleSize2", 6.8,  minVal = 0, maxVal = 80, vary = False)
modelRef.setParam("sigParticleSize1", 0.0752,  minVal = 0, maxVal = 0.2, vary = False)
modelRef.setParam("sigParticleSize2", 0.5976,  minVal = 0, maxVal = 0.8, vary = False)
...
modelRef.setParam("dSurfactant1", 16.900000000000002,  minVal = 0, maxVal = 50, vary = True)
modelRef.setParam("i0", 0.23,  minVal = 0, maxVal = 10, vary = True)
modelRef.setParam("bg", 0.00202,  minVal = 0, maxVal = 0.02, vary = False)
