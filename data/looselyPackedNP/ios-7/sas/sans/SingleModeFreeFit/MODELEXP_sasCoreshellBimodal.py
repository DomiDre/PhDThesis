...
modelRef.setParam("d", 19.625,  minVal = 0, maxVal = 25, vary = True)
modelRef.setParam("i0", 0.038,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("i0Oleic", 0.48,  minVal = 0, maxVal = 40, vary = True)
