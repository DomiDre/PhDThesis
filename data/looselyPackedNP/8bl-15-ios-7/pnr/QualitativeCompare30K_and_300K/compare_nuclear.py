...
data_path_300K = "./ES_S15_300K_7Oe_virgin_tranformed_angs_masked_qz_I_corrected_combined.xy"
data_path_30K = "./ES_S15_30K_ZFC_7Oe_virgin_tranformed_angs_masked_qz_I_corrected_combined.xy"
...
def plotplots():
        ...
        axR.errorbar(qz_300K, I_300K*sf300, sI_300K*sf300,\
                    marker='o', linestyle='None', color=exp_points_color_300K,\
                    label="NR @ 300 K", markersize=2, capsize=2,\
                    elinewidth=1)
        axR.errorbar(qz_30K, I_30K*sf30, sI_30K*sf30, marker='o', linestyle='None',\
