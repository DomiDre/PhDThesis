...
gf_rPlus_file = cwd  + '/data/footprintCorrect/ES_S12_300K_4mT_refl_uu_fcorrected.xye'
gf_rMinus_file = cwd + '/data/footprintCorrect/ES_S12_300K_4mT_refl_du_fcorrected.xye'
sat_rPlus_file = cwd  + '/data/footprintCorrect/ES_S12_300K_500mT_refl_uu_fcorrected.xye'
sat_rMinus_file = cwd + '/data/footprintCorrect/ES_S12_300K_500mT_refl_du_fcorrected.xye'
rem_rPlus_file = cwd +  '/data/footprintCorrect/ES_S12_300K_4mT_Remanence_refl_uu_fcorrected.xye'
rem_rMinus_file = cwd + '/data/footprintCorrect/ES_S12_300K_4mT_Remanence_refl_du_fcorrected.xye'

labeltext = '8BL-15-IOS-11\n300 K'
...
q_sat_p, I_sat_p, sI_sat_p = q_sat_p[:-5], I_sat_p[:-5], sI_sat_p[:-5]
q_sat_m, I_sat_m, sI_sat_m = q_sat_m[:-5], I_sat_m[:-5], sI_sat_m[:-5]

q_rem_p, I_rem_p, sI_rem_p = get_data(rem_rPlus_file)
q_rem_m, I_rem_m, sI_rem_m = get_data(rem_rMinus_file)
q_rem_p, I_rem_p, sI_rem_p = q_rem_p[:-5], I_rem_p[:-5], sI_rem_p[:-5]
q_rem_m, I_rem_m, sI_rem_m = q_rem_m[:-5], I_rem_m[:-5], sI_rem_m[:-5]
