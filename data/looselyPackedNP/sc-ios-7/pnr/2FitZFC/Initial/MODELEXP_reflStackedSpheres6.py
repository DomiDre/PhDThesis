...
dataRef.loadFromFile('../../data/footprint_corrected/ES_S17_30K_ZFC_7Oe_reduced_in_x_ai_uu_masked_qz_I_fcorrected.xye', ['p'])
dataRef.loadFromFile('../../data/footprint_corrected/ES_S17_30K_ZFC_7Oe_reduced_in_x_ai_du_masked_qz_I_fcorrected.xye', ['m'])
...
modelRef.setParam("roughness", 9.6,  minVal = 0.0, maxVal = 40, vary = True)
modelRef.setParam("roughnessSlope", 0.0004,  minVal = 0.0, maxVal = 0.1, vary = True)
modelRef.setParam("packingDensity1", 0.808,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity2", 0.6880000000000001,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity3", 0.616,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity4", 0.612,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity5", 0.648,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity6", 0.628,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity7", 0.606,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity8", 0.5660000000000001,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity9", 0.514,  minVal = 0.0, maxVal = 2.0, vary = True)
modelRef.setParam("packingDensity10", 0.404,  minVal = 0.0, maxVal = 2.0, vary = True)
...
modelRef.setParam("dSpacer", 37.5,  minVal = 0, maxVal = 100, vary = False)
...
modelRef.setConstantParam("polarizationEfficiency", 1)
