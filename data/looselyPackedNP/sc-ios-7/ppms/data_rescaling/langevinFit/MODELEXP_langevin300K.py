...
modelRef.setParam("Ms", 0.12024767281133242,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("mu", 4350.855,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", -0.05763114725502799,  minVal = -0.5, maxVal = 0.5, vary = True)
