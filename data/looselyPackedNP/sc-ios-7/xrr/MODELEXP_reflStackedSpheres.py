...
modelRef.setParam("bg", 2.5500000000000003e-05,  minVal = 0.0, maxVal = 0.0001, vary = True)
modelRef.setParam("roughness", 4.387402007757028,  minVal = 0.0, maxVal = 20, vary = True)
modelRef.setParam("roughnessSlope", 0.03299687329683484,  minVal = 0.0, maxVal = 0.1, vary = True)
modelRef.setParam("packingDensity1", 0.992,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity2", 0.774,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity3", 0.598,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity4", 0.49,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity5", 0.454,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity6", 0.5,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity7", 0.540542504836051,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity8", 0.552,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity9", 0.512,  minVal = 0.0, maxVal = 2.0, vary = False)
modelRef.setParam("packingDensity10", 0.354,  minVal = 0.0, maxVal = 2.0, vary = False)
...
modelRef.setParam("dSpacer", 52.305436924876794,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("sldSpacer", 2.44143263324272e-06,  minVal = 0, maxVal = 3e-05, vary = True)
