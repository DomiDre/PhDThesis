...
datafile = '../../rawdata/PMK18_HYST_10K.DAT'
...
modelRef.setParam("Ms", 14.44,  minVal = 0, maxVal = 20, vary = True)
modelRef.setParam("mu", 10950.635,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", 0.41700000000000004,  minVal = -0.5, maxVal = 0.5, vary = True)
