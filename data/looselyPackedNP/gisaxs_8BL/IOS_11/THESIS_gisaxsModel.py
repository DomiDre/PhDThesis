...
sample_name = '8BL-x-IOS-11'
Chapter = 'looselyPackedNP'

fit_file_15 = "../../8bl-15-ios-11/gisaxs/fit/fit_result.dat"
fit_file_40 = "../../8bl-40-ios-11/gisaxs/fit/fit_result.dat"

saxs_file_15 = '../../8bl-15-ios-11/gisaxs/rawdata/PMK18.xye'
saxs_file_40 = '../../8bl-40-ios-11/gisaxs/rawdata/PMK18.xye'
...
ax.errorbar(q_15, I_15-bg_15, sI_15,
  linestyle='None',
  color='#FAAB2D',
  label='8BL-15-IOS-11', zorder=0, capsize=0, marker='.', alpha=1)

ax.errorbar(q_saxs, I_saxs*sf_40*shift_40, sI_saxs*sf_40*shift_40,
  linestyle='None',
  color='#EE292F',
  label='IOS-11', zorder=1, capsize=0, marker='.', alpha=0.2)
