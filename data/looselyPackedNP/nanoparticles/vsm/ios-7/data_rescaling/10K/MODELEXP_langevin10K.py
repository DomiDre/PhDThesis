...
datafile = '../../rawdata/KWI338_HYST_10K.DAT'
...
modelRef.setParam("Ms", 6.46,  minVal = 0, maxVal = 20, vary = True)
modelRef.setParam("mu", 3660.8779999999997,  minVal = 1, maxVal = 30000, vary = False)
modelRef.setParam("chi", 0.009000000000000008,  minVal = -0.5, maxVal = 0.5, vary = False)
