...
modelRef.setParam("Ms", 3.30721668450248,  minVal = 0, maxVal = 20, vary = True)
modelRef.setParam("mu", 3630.879,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", -0.1635524622408201,  minVal = -0.5, maxVal = 0.5, vary = True)
