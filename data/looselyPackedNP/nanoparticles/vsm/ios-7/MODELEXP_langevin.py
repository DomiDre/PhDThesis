...
modelRef.setParam("Ms", 168.0,  minVal = 0, maxVal = 400, vary = True)
modelRef.setParam("mu", 3771.752234364808,  minVal = 0, maxVal = 5000, vary = True)
modelRef.setParam("chi", 10.16,  minVal = -20, maxVal = 20, vary = True)
