...
fit_params = temIOS7.fitresults.params
#Plot Fit:
fig = plt.figure()
...
ax.text(0.47, 0.85,
  f'$\mu_1 \,=\,{getValueWithErrorString(fit_params["logmu0"])}\, nm$\n'+
  f'$\sigma_1 \,=\,{getValueWithErrorString(fit_params["logstd0"], 100)}\, \%$\n\n'+
  r'$\alpha'+f' \,=\,{getValueWithErrorString(fit_params["N1"], 100)}\, \%$\n'+
  f'$\mu_2 \,=\,{getValueWithErrorString(fit_params["logmu1"])}\, nm$\n'+
  f'$\sigma_2 \,=\,{getValueWithErrorString(fit_params["logstd1"], 100)}\, \%$',
  color='black',
