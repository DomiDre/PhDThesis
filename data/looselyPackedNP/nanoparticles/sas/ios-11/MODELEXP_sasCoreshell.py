...
modelRef.setParam("r", 52.75643570478779,  minVal = 0, maxVal = 80, vary = True)
modelRef.setParam("sigR", 0.06042876678535328,  minVal = 0, maxVal = 0.1, vary = True)
modelRef.setParam("i0_saxs", 0.5327367340659722,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("bg_saxs", 0.008785834152103442,  minVal = 0, maxVal = 0.02, vary = True)

modelRef.setParam("d", 19.040816101113663,  minVal = 0, maxVal = 30, vary = True)
modelRef.setParam("i0_sans", 0.26876232909700154,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("bg_sans", 0.0,  minVal = 0, maxVal = 0.02, vary = False)

modelRef.setParam("dTheta_sa", 0.0030636665395008555,  minVal = 0, maxVal = 0.01, vary = True)
modelRef.setParam("dTheta_la", 0.003585960723466359,  minVal = 0, maxVal = 0.01, vary = True)
modelRef.setParam("sldShell_sans", 2.6410068717886718e-06,  minVal = 3.12e-08, maxVal = 5.664e-06, vary = True)
