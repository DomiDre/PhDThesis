...
modelRef.setParam("particleSize", 54.27773836662054,  minVal = 0, maxVal = 80, vary = True)
modelRef.setParam("dShell", 4.29033367568199,  minVal = 0, maxVal = 80, vary = True)
modelRef.setParam("dSurfactant", 19.6,  minVal = 0, maxVal = 80, vary = False)
modelRef.setParam("sigParticleSize", 0.05430514365017926,  minVal = 0, maxVal = 0.1, vary = True)
modelRef.setParam("i0", 0.3319222939913381,  minVal = 0, maxVal = 1, vary = True)
