...
modelRef.setParam("packingDensity", 0.6980000000000001,  minVal = 0.0, maxVal = 1.0, vary = True)
...
modelRef.setParam("layerDistance", -24.799999999999997,  minVal = -50, maxVal = 50, vary = True)
