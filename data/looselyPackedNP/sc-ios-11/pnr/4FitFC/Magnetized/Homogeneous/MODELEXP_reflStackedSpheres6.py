...
modelRef.setParam("magDensity1", 6.491123060708616e-07,  minVal = 0, maxVal = 3e-06, vary = True)
modelRef.setParam("magDensity2", 6.39e-07,  minVal = 0, maxVal = 3e-06, vary = False)
modelRef.setParam("magDensity3", 6.39e-07,  minVal = 0, maxVal = 3e-06, vary = False)
modelRef.setParam("magDensity4", 6.39e-07,  minVal = 0, maxVal = 3e-06, vary = False)
modelRef.setParam("magDensity5", 6.39e-07,  minVal = 0, maxVal = 3e-06, vary = False)
modelRef.setParam("magDensity6", 6.39e-07,  minVal = 0, maxVal = 3e-06, vary = False)
