...
sld_datapath = "../0FitSphereLayerCSSWithSpacer/fit_sld.dat"
...
left_idx = get_idx(z, 5)
z_left = z[left_idx]
right_idx = get_idx(z, 55)
...
vol_core = 4/3 * np.pi * 3.8**3
vol_particle = 4/3 * np.pi * (3.8+1.6)**3
vol_shell = vol_particle - vol_core
iron_oxide_sld = (vol_core * 8.34 + vol_shell * 7.00) / vol_particle
