...
fit_fileZFC_ini = cwd + "/3FitZFC/Initial/Nuclear/fit_result.dat"
sld_fileZFC_ini = cwd + "/3FitZFC/Initial/Nuclear/fit_sld.dat"
fit_fileZFC_sat = cwd + "/3FitZFC/Magnetized/fit_result.dat"
sld_fileZFC_sat = cwd + "/3FitZFC/Magnetized/fit_sld.dat"
fit_fileZFC_rem = cwd + "/3FitZFC/Remanence/fit_result.dat"
sld_fileZFC_rem = cwd + "/3FitZFC/Remanence/fit_sld.dat"
...
p_gf_p = ax.errorbar(q_ini_p_fit, I_ini_p_fit*sf_ini, sI_ini_p_fit*sf_ini,
  linestyle='-',
  label='ZFC, GF, $R^{+}$',
  zorder=0, capsize=0, marker='.', markersize=1, color='#793394')
p_gf_m = ax.errorbar(q_ini_m_fit, I_ini_m_fit*sf_ini, sI_ini_m_fit*sf_ini,
  linestyle='-',
  label='ZFC, GF, $R^{-}$',
  zorder=0, capsize=0, marker='.', markersize=1, color='#7F0128')

p_sat_p = ax.errorbar(q_sat_p_fit, I_sat_p_fit*sf_sat, sI_sat_p_fit*sf_sat,
  linestyle='-',
  label='730 mT, $R^{+}$',
  zorder=0, capsize=0, marker='.', markersize=1)
p_sat_m = ax.errorbar(q_sat_m_fit, I_sat_m_fit*sf_sat, sI_sat_m_fit*sf_sat,
  linestyle='-',
  label='730 mT, $R^{-}$',
  zorder=0, capsize=0, marker='.', markersize=1)

p_rem_p = ax.errorbar(q_rem_p_fit, I_rem_p_fit*sf_rem, sI_rem_p_fit*sf_rem,
  linestyle='-',
  label='Remanence, $R^{+}$',
  zorder=0, capsize=0, marker='.', markersize=1, color='#FAAB2D')
p_rem_m = ax.errorbar(q_rem_m_fit, I_rem_m_fit*sf_rem, sI_rem_m_fit*sf_rem,
  linestyle='-',
  label='Remanence, $R^{-}$',
  zorder=0, capsize=0, marker='.', markersize=1, color='#76C152')
...
ax.plot(q_ini_p_fit, Imodel_ini_p_fit*sf_ini, zorder=1, color=color_variant('#793394', -100), marker='None')
ax.plot(q_ini_m_fit, Imodel_ini_m_fit*sf_ini, zorder=1, color=color_variant('#7F0128', -100), marker='None')
