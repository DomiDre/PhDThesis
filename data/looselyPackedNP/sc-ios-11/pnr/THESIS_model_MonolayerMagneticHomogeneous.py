...
fit_file = cwd + "/1FitMagneticHomogeneousLayer/fit_result.dat"
sld_file = cwd + "/1FitMagneticHomogeneousLayer/fit_sld.dat"
...
refl_pngfile = f"{Chapter}_VerticalStructure_{sample_name}_PNR300K_500mT_HomogeneousModel.png"
