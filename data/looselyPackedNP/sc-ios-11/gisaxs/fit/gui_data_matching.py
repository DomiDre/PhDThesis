...
class GuiApp(cPlotAndFit):
  def init_data(self):
    qmin = 0.12
    qsf = 4e-4
    gisaxsdata = np.genfromtxt("../ES-S14_Yoneda.xy")
    ...
    saxsdata = np.genfromtxt("../rawdata/PMK18.xye")
    ...
    self.p.add("gisaxs_background", 456.14193310003435, min = 0, max = 5000, vary = True)
    self.p.add("gisaxs_scale", 0.0001317715112028134, min = 1e-05, max = 0.001, vary = True)
    self.p.add("R", 5.701673367019156, min = 4, max = 6, vary = True)
    self.p.add("vol_frac", 0.44735838281522583, min = 0.2, max = 0.6, vary = True)
