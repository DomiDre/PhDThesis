...
modelRef.setParam("dShell", 33.2231231, minVal = 0, maxVal = 70, vary=True)
modelRef.setParam("dSurfactant", 14.1,  minVal = 0, maxVal = 80, vary = True)
modelRef.setParam("i0", 0.05416569,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("dTheta_sa", 0.00173367, minVal = 0, maxVal = 0.01, vary=True)
modelRef.setParam("dTheta_la", 0.00281855, minVal = 0, maxVal = 0.01, vary=True)

modelRef.setConstantParam("bg", 0.)
modelRef.setConstantParam("pVal", 2.15336360)
modelRef.setConstantParam("particleSize", 61.2588026)
