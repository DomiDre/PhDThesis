...
modelRef.setParam("dShell", 11.8474011, minVal = 0, maxVal = 70, vary=True)
modelRef.setParam("dSurfactant", 18.3474150,  minVal = 0, maxVal = 80, vary = True)
modelRef.setParam("i0", 0.02705136,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("bg", 0.00269573,  minVal = 0, maxVal = 0.1, vary = True)
modelRef.setParam("i0Oleic", 0.00250635, minVal = 0, maxVal = 5, vary=True)
modelRef.setParam("dTheta_sa", 0.00251930, minVal = 0, maxVal = 0.01, vary=True)
modelRef.setParam("dTheta_la", 0.00265073, minVal = 0, maxVal = 0.01, vary=True)
