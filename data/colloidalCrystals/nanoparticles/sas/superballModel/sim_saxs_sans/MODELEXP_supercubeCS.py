...
dataRef.sliceDomain(0.01,0.3)

modelRef = app.setModel(SuperballCSSCoupledSigDOA, DataResolution)
modelRef.setResolution(['sans'])
modelRef.setParam("particleSize",     57.5095104,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("dShell",           20.8137350,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("dSurfactant",      13.2533945,  minVal = 0, maxVal = 50, vary = True)
...
modelRef.setParam("i0_saxs",          0.02062452,  minVal = 0, maxVal = 0.1, vary = True)
modelRef.setParam("i0Oleic",          0.77523137, minVal = 0, maxVal = 100, vary=True)
modelRef.setParam("i0_sans",          0.03834884,  minVal = 0, maxVal = 10, vary = True)
modelRef.setParam("bg_sans",          0.000048,  minVal = 0, maxVal = 0.1, vary = True)
