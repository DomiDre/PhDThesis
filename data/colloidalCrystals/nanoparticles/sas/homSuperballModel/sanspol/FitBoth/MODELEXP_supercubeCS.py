...
modelRef.setParam("magSldCore", 1e-6,  minVal = 0, maxVal = 5e-06, vary = True)
modelRef.setParam("magSldShell", 1e-06,  minVal = 0, maxVal = 5e-06, vary = True) #3.2842e-07 +/- 2.6516e-08 (8.07%)
