...
modelRef.setParam("d", 14.1,  minVal = 0, maxVal = 80, vary = False)
...
modelRef.setConstantParam("r", 61.2588026)
modelRef.setConstantParam("sigR", 0.07247489)

modelRef.setConstantParam("sldCore", 6.9992e-6) # Fe3O4 8.3841 A
