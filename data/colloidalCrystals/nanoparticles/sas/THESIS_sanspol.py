...
fit_file = cwd + "/superballModel/sanspol/intermediateResult.dat"
...
q_min, q_max = 1e-2, 0.16
I_min, I_max = 1.5e-3, 12e0
...
sanspol_p_la_qmodel, sanspol_p_la_I, sanspol_p_la_sI, sanspol_p_la_Imodel = get_clean_data(data, 'p_la')
sanspol_m_la_qmodel, sanspol_m_la_I, sanspol_m_la_sI, sanspol_m_la_Imodel = get_clean_data(data, 'm_la')
sanspol_p_sa_qmodel, sanspol_p_sa_I, sanspol_p_sa_sI, sanspol_p_sa_Imodel = get_clean_data(data, 'p_sa')
sanspol_m_sa_qmodel, sanspol_m_sa_I, sanspol_m_sa_sI, sanspol_m_sa_Imodel = get_clean_data(data, 'm_sa')
...
ax.plot(sanspol_p_sa_qmodel, sanspol_p_sa_Imodel, marker='None', linestyle='-',\
...
ax.errorbar(sanspol_p_la_q, sanspol_p_la_I, sanspol_p_la_sI,\
  ...
  zorder=0, capsize=0, marker='.')
ax.plot(sanspol_p_la_qmodel, sanspol_p_la_Imodel, marker='None', linestyle='-',\
  color=color_variant('#76C152', -150), zorder=1)
...
ax.plot(sanspol_m_sa_qmodel, sanspol_m_sa_Imodel, marker='None', linestyle='-',\
...
ax.errorbar(sanspol_m_la_q, sanspol_m_la_I, sanspol_m_la_sI,\
  ...
  zorder=0, capsize=0, marker='.')
ax.plot(sanspol_m_la_qmodel, sanspol_m_la_Imodel, marker='None', linestyle='-',\
  color=color_variant('#EE292F', -150), zorder=1)
