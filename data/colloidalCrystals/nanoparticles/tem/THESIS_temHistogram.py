...
temOlFeC = TEMSpheres()
temOlFeC.Nbins = bins
lengths = temOlFeC.load_csv(cwd + "/EF3147_10_counts.xls")
temOlFeC.load(lengths*0.9049)
temOlFeC.prepare_length_histogram(density=True)
temOlFeC.fit_lognormal(11, 0.1, density=True)
temOlFeC.export_fit_result(cwd + "/Ol_Fe_C_size_dist.xy")
fit_params = temOlFeC.fitresults.params
...
ax.errorbar(
  temOlFeC.bins, temOlFeC.counts, temOlFeC.errors, ls='None',
...
ax.plot(x_for_fit_display,\
  temOlFeC.lognormal(temOlFeC.p_result, x_for_fit_display),\
