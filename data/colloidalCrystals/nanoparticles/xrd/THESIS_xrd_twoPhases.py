...
datfile = 'DD144.dat'
prfFile = cwd + '/LeBail/TwoPhases/fe2o3_feo.prf'
outFile = cwd + '/LeBail/TwoPhases/fe2o3_feo.out'

chapter = 'colloidalCrystals'
sample_name = 'Ol_Fe_C'

savefile = chapter + '_XRD_Fe3O4WustiteFit_' + sample_name
...
ax.legend([green_patch, red_patch], ['$Fe_{3 - \delta} O_4$', 'FeO'], loc='upper left', fontsize=10, bbox_to_anchor=(0, 0.9))
