...
modelRef.setParam("Ms", 8.8,  minVal = 0, maxVal = 50, vary = True)
modelRef.setParam("mu", 61600.0,  minVal = 20000, maxVal = 100000, vary = True)
modelRef.setParam("chi", 0.4800000000000004,  minVal = -10, maxVal = 10, vary = True)
