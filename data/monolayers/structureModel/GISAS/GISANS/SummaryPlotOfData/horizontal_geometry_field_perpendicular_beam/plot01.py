...
handler.Imax = 2e-2
# #sat
handler.loadAndProject('../../0rawdata/020', np.arange(781, 805, 1))
handler.plotData('DD175.28 Saturated', 'dd175_28_sat.png')
handler.plotYoneda('Saturated')


#rem
handler.loadAndProject('../../0rawdata/020', np.arange(805, 829, 1))
handler.plotData('DD175.28 Remanence', 'dd175_28_rem.png')
handler.plotYoneda('Remanence')


#negField
handler.loadAndProject('../../0rawdata/020', np.arange(829, 853, 1))
