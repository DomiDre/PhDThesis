...
chapter = 'monolayers'
savefile = chapter + '_GISANS_ML-Ac-CoFe-C-2_250K4T'
...
qy_sat_p, qz_sat_p, data_sat_p, I_sat_p, sI_sat_p = load_files('./GISANS/0rawdata/020', np.arange(673, 685, 2))
qy_sat_m, qz_sat_m, data_sat_m, I_sat_m, sI_sat_m = load_files('./GISANS/0rawdata/020', np.arange(674, 685, 2))
