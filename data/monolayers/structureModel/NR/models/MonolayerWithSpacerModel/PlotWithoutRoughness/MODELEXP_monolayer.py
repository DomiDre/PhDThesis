...
modelRef.setParam("roughnessSubstrate", 0,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessSpacer",    0,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessShellCube", 0,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessCubeShell", 0,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessShellAir",  0,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("packingDensity", 0.5579011534877276,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("thicknessShellTop", 0.08880869466169061,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("thicknessShellLower", 57.2668672394545,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("thicknessSpacer", 31.625472964298556,  minVal = 0, maxVal = 100, vary = True)
