...
modelRef.setParam("roughnessSubstrate", 20.04092512372098,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessSpacer", 23.527752731849667,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessShellCube", 14.570081973637977,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessCubeShell", 22.316233490507724,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("roughnessShellAir", 8.4,  minVal = 0, maxVal = 100, vary = False)
modelRef.setParam("packingDensity", 0.5000622389461962,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("thicknessShellTop", 39.6,  minVal = 0, maxVal = 100, vary = False)
modelRef.setParam("thicknessShellLower", 36.60112373674055,  minVal = 0, maxVal = 100, vary = True)
modelRef.setParam("thicknessSpacer", 24.257353870635196,  minVal = 0, maxVal = 100, vary = True)
