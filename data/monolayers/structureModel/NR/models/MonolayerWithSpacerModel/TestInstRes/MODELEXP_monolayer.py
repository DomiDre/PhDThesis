...
from modelexp.models.reflectometry import CubeCSMonolayerOnSpacer, Magnetic, InstrumentalResolution
...
modelRef = app.setModel(CubeCSMonolayerOnSpacer, [Magnetic, InstrumentalResolution])
...
modelRef.setParam("dTheta", 1.3999999999999998e-07,  minVal = 0, maxVal = 1e-3, vary = False)
modelRef.setParam("dWavelength", 1.3999999999999998e-07,  minVal = 0, maxVal = 0.1, vary = False)
modelRef.setParam("wavelength", 5,  minVal = 0, maxVal = 10, vary = False)
