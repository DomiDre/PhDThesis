...
sample_name = 'ML_Ac-CoFe-C-2_WithSpacer_FreeSize'
Chapter = 'monolayers'
fit_file = cwd + "/models/FreeSizeMonolayerWithSpacer/fit_result.dat"
sld_file = cwd + "/models/FreeSizeMonolayerWithSpacer/fit_sld.dat"
