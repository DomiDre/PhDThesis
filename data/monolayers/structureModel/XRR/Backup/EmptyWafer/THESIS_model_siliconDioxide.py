...
sample_name = 'SiliconSiliconDioxide'
Chapter = 'monolayers'
fit_file = cwd + "/models/SiliconDioxideLayer/fit_result.dat"
sld_file = cwd + "/models/SiliconDioxideLayer/fit_sld.dat"

labeltext = 'Silicon/Silicon Dioxide'
q_min, q_max = 1e-2, 0.249
