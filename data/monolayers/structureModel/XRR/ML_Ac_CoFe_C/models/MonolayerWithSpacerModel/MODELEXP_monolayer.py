...
modelRef.setParam("qShift", -0.0025711374043358272,  minVal = -0.01, maxVal = 0.01, vary = False)
modelRef.setParam("roughnessSubstrate", 2.3128366807801144,  minVal = 0.0, maxVal = 50, vary = False)
modelRef.setParam("roughnessSpacer", 2.5,  minVal = 0.0, maxVal = 50, vary = False)
modelRef.setParam("roughnessCubeShell", 12.200000000000001,  minVal = 0.0, maxVal = 50, vary = False)
modelRef.setParam("packingDensity", 0.491,  minVal = 0.0, maxVal = 1.0, vary = False)
modelRef.setParam("thicknessShellLower", 23.5,  minVal = 0, maxVal = 100, vary = False)
modelRef.setParam("thicknessSpacer", 36.1,  minVal = 0, maxVal = 100, vary = False)
modelRef.setParam("sldSpacer", 1.2150000000000002e-05,  minVal = 0, maxVal = 3e-05, vary = False)
modelRef.setParam("sldShellLower", 6.86e-06,  minVal = 0, maxVal = 2e-05, vary = False)
