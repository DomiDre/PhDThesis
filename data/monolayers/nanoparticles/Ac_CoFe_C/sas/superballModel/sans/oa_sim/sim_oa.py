...
modelRef.setParam("i0", 4.348, minVal = 0, maxVal = 5, vary=True)
modelRef.setParam("r", 15,  minVal = 0, maxVal = 40, vary = True)
modelRef.setParam("dTheta_sa", 0.00,  minVal = 0, maxVal = 0.01, vary = True)
modelRef.setParam("dTheta_la", 0.00,  minVal = 0, maxVal = 0.01, vary = True)
...
modelRef.setConstantParam('dWavelength', 0.0)#84932)
