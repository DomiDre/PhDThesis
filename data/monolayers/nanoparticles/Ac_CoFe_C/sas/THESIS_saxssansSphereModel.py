...
Chapter = 'monolayers'
saxs_fit_file = cwd + "/sphereModel/saxs/fit_result.dat"
saxs_sld_file = cwd + "/sphereModel/saxs/fit_sld.dat"

sans_fit_file = cwd + "/sphereModel/sans/fit_result.dat"
sans_sld_file = cwd + "/sphereModel/sans/fit_sld.dat"

q_min, q_max = 1e-2, 0.25
I_min, I_max = 8e-4, 2e2

saxs_legend_label = "SAXS @ GALAXI"
sans_legend_label = "SANS @ D22"

pngfile = Chapter + '_SAS_' + sample_name + "_SASSphereModelFit.png"
