...
sans_initial_file_superball = cwd + "/superballModel/sans/initial/superballData_simulation.xy"
...
dataRef_sa = XyeData()
dataRef_sa.loadFromFile(cwd + '/experimental_data/AH11_nuclear_SA.dat')
q_sa, I_sa, sI_sa = dataRef_sa.getData()
dataRef_la = XyeData()
dataRef_la.loadFromFile(cwd + '/experimental_data/AH11_nuclear_LA.dat')
...
#   color='#0EA8DF',
#   label='OleicAcid', zorder=1, alpha=0.8)
