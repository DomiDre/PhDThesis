...
datafile = '../../rescale/Ac_CoFe_C_Dispersion_300K_LangevinSAXSscaled.xye'
...
modelRef.setParam("Ms", 300.0,  minVal = 0, maxVal = 400, vary = True)
modelRef.setParam("mu", 22100.0,  minVal = 0, maxVal = 50000, vary = True)
modelRef.setParam("chi", -0.9000000000000341,  minVal = -300, maxVal = 0, vary = True)
