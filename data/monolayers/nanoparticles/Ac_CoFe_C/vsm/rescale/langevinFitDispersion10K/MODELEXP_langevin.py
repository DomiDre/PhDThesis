...
datafile = '../../data_dispersion/AH11_HYST_100OE_10K.DAT'
...
modelRef.setParam("Ms", 6.28,  minVal = 0, maxVal = 20, vary = False)
modelRef.setParam("mu", 23130.229,  minVal = 1, maxVal = 30000, vary = False)
modelRef.setParam("chi", -0.009599999999999997,  minVal = -0.1, maxVal = 0.1, vary = False)
