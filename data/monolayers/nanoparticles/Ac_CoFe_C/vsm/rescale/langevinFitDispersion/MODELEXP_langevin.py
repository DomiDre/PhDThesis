...
modelRef.setParam("Ms", 1.9934283701567237,  minVal = 0, maxVal = 5, vary = True)
modelRef.setParam("mu", 23157.342028224662,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", -0.009599999999999997,  minVal = -0.1, maxVal = 0.1, vary = True)
