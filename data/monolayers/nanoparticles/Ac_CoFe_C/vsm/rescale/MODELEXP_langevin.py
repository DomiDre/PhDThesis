...
datafile = '../rawdata/DD226_2_HYST_300K.DAT'
...
modelRef.setParam("Ms", 0.032850625705573844,  minVal = 0, maxVal = 2, vary = True)
modelRef.setParam("mu", 11310.623,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", -0.030600945826540882,  minVal = -0.5, maxVal = 0.5, vary = True)
modelRef.setParam("sigMu", 0.3795,  minVal = 0, maxVal = 1.5, vary = False)
