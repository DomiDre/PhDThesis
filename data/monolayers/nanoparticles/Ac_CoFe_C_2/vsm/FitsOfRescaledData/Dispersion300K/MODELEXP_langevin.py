...
modelRef.setParam("Ms", 419.0,  minVal = 0, maxVal = 500, vary = True)
modelRef.setParam("mu", 20700.0,  minVal = 0, maxVal = 50000, vary = True)
modelRef.setParam("chi", -3.3000000000000114,  minVal = -300, maxVal = 0, vary = True)
