...
ax_inset = fig.add_axes([left+0.03, bottom+0.03, 0.35, 0.4])

ax.errorbar(q_sphere, I_sphere, sI_sphere,
  linestyle='None',
  label='Ol-CoFe-C', zorder=0, capsize=0, marker='.', alpha=1)
...
ax_inset.set_xlim([0.06, 0.14])
ax_inset.set_ylim([1.5e-2, 3e-1])
