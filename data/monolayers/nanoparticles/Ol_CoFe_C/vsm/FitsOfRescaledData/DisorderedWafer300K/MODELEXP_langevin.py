...
datafile = '../../rescale/Ol_CoFe_C_DisorderedWafer_300K_LangevinSAXSscaled.xye'
...
modelRef.setParam("Ms", 55.225129521391224,  minVal = 0, maxVal = 400, vary = True)
modelRef.setParam("mu", 6250.0,  minVal = 0, maxVal = 50000, vary = False)
modelRef.setParam("chi", 37.771544770518915,  minVal = -300, maxVal = 300, vary = True)
