...
datafile = '../../rescale/Ol_CoFe_C_Dispersion_300K_LangevinSAXSscaled.xye'
...
modelRef.setParam("Ms", 57.43434985353311,  minVal = 0, maxVal = 400, vary = True)
modelRef.setParam("mu", 6280.0,  minVal = 0, maxVal = 20000, vary = False)
modelRef.setParam("chi", 37.73793043987058,  minVal = -300, maxVal = 300, vary = True)
