...
samplename = 'Ol_CoFe_C_DisorderedWafer'
rescale('../data_disorderedWafer/DD227_HYST_300K.DAT', f'{samplename}_300K')
rescale('../data_disorderedWafer/DD227_HYST_10K.DAT',  f'{samplename}_10K')
rescale('../data_disorderedWafer/DD227_FCW_100OE.DAT',       f'{samplename}_FCw', True)
rescale('../data_disorderedWafer/DD227_ZFCW_100OE.DAT', f'{samplename}_ZFCw', True)