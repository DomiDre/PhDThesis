...
datfile = 'DD67.dat'
prfFile = 'CoFe2O4Wustite.prf'
outFile = 'CoFe2O4Wustite.out'
...
for i, tth_reflex in enumerate(fit_reflexes['Fe0']['tth']):
  qReflex = toQ(tth_reflex)
  closestIobs = Imodel[data.getClosestIdx(tth, tth_reflex)] #fit_reflexes['CoFe2O4']['Iobs'][i] #
  ax.plot(
    [qReflex, qReflex], [0.15, closestIobs],
...
ax.legend([green_patch, red_patch], ['$CoFe_2O_4$', 'FeO'], loc='upper left')
