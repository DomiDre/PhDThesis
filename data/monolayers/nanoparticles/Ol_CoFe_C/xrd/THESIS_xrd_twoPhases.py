...
datfile = 'DD67.dat'
prfFile = cwd + '/LeBail/TwoPhases/cofe2o4_feo.prf'
outFile = cwd + '/LeBail/TwoPhases/cofe2o4_feo.out'

chapter = 'monolayer'
sample_name = 'Ol_CoFe_C'

savefile = chapter + '_XRD_CoFe2O4WustiteFit_' + sample_name
...
for i, tth_reflex in enumerate(fit_reflexes['CoFe2O4']['tth']):
...
ax.legend([green_patch, red_patch], ['$CoFe_2O_4$', 'FeO'], loc='upper left', fontsize=10, bbox_to_anchor=(0, 0.9))
