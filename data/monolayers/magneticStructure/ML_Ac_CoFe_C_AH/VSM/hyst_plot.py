...
T_10K, B_10K, M_10K, sM_10K = load_ppms_dat('./DD205_4_KOELNPPMS_HYST_100OE_10K.DAT')

m_SiliconTheory = -31.078
M_10K -= (m_SiliconTheory-3)*B_10K
M_10K /= 6*4*(4.69420801*2)*1e-6*1000*10.1/13
