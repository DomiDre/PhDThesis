...
ax.plot(q_rem_p_fit, Imodel_rem_p_fit*sf_rem, zorder=1, color=color_variant('#0EA8DF', -100), marker='None')
ax.plot(q_rem_m_fit, Imodel_rem_m_fit*sf_rem, zorder=1, color=color_variant('#EE292F', -100), marker='None')
...
ax_sld.plot(z_rem, sldMag_rem, marker='None', color=color_variant('#0EA8DF', -100))
