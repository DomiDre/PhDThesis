...
refl_pngfile = f"{Chapter}_MagneticStructure_{sample_name}_PNR_ZFC5K.png"
...
z_sat, sld_sat, sldMag_sat = get_sld_data(sld_fileZFC_sat)
...
ax_sld.plot(z_rem, sldMag_rem, marker='None', color=color_variant('#FAAB2D', -100))
