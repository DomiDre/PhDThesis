...
from modelexp.models.reflectometry import CubeCSMonolayerOnSpacerPartial, Magnetic, DataResolution
...
modelRef = app.setModel(CubeCSMonolayerOnSpacerPartial, [Magnetic, DataResolution])
modelRef.setResolution()
modelRef.setParam("i0", 1.0335,  minVal = 0, maxVal = 1.5, vary = False)
modelRef.setParam("magSldCore", 3.6184588664584085e-06,  minVal = -2e-06, maxVal = 4e-06, vary = True)
modelRef.setParam("magCoverage", 0.20231157560625473,  minVal = 0, maxVal = 1, vary = True)
