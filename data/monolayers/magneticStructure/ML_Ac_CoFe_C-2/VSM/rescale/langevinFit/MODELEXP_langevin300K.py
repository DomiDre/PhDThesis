...
modelRef.setParam("Ms", 0.05178661939653334,  minVal = 0, maxVal = 1, vary = True)
modelRef.setParam("mu", 9582.444710084479,  minVal = 1, maxVal = 30000, vary = True)
modelRef.setParam("chi", -0.041801864198730165,  minVal = -0.5, maxVal = 0.5, vary = True)
