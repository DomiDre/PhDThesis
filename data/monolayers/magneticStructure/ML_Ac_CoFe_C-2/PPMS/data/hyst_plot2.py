...
T_2K, B_2K, M_2K, sM_2K = load_ppms_dat("DD175_23_HYST_2K_100OE.DAT")
T_5K, B_5K, M_5K, sM_5K = load_ppms_dat("DD175_23_HYST_5K_100OE.DAT")
T_10K, B_10K, M_10K, sM_10K = load_ppms_dat("DD175_23_HYST_10K_100OE.DAT")
T_20K, B_20K, M_20K, sM_20K = load_ppms_dat("DD175_23_HYST_20K_100OE.DAT")
T_300K, B_300K, M_300K, sM_300K = load_ppms_dat("DD175_23_HYST_300K.DAT")

m_SiliconTheory = -31.078
M_2K -= m_SiliconTheory*B_2K
M_5K -= m_SiliconTheory*B_5K
M_10K -= (m_SiliconTheory+10)*B_10K
M_20K -= (m_SiliconTheory+8)*B_20K
mRT = -42
M_300K -= mRT*B_300K
...
ax.set_xlim(-6, 6)
ax.set_ylim(-200, 200)
fig.savefig('DD175_23_hyst_10K_with_virgin.png')
plt.show()