...
savefile = f'{chapter}_PPMS_VSM_350K_{sample_name}'

datfile = './rescale/ML_Ac_CoFe_C_2star_350K_rescaled.xye'
...
Ms = 413.042598
mu = 23500
dispersion_M = fortMag.langevin.magnetization(B, Ms, mu, 350, 0)
