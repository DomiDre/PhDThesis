...
def run_simulation():
    ...
    simulation_uu = get_simulation(ba.kvector_t(0.0, 1.0, 0.0), ba.kvector_t(0.0, 1.0, 0.0))
    ...
    simulation_dd = get_simulation(ba.kvector_t(0.0, -1.0, 0.0), ba.kvector_t(0.0, -1.0, 0.0))
    ...
    simulation_ud = get_simulation(ba.kvector_t(0.0, 1.0, 0.0), ba.kvector_t(0.0, -1.0, 0.0))
    ...
    simulation_du = get_simulation(ba.kvector_t(0.0, -1.0, 0.0), ba.kvector_t(0.0, 1.0, 0.0))
