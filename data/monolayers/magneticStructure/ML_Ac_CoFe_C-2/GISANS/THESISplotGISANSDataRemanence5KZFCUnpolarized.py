...
chapter = 'monolayers'
savefile = chapter + '_GISANS_ML-Ac-CoFe-C-2_ZFC5K_Unpolarized_Remanence'
...
qy_sat, qz_sat, data_sat, I_sat, sI_sat = load_files('./0rawdata/020', np.arange(959, 970, 1))
...
pcm = ax.pcolormesh(
  qy_sat*10, qz_sat*10, data_sat.T,\
...
ax2.plot([0.49, 0.49], [2e2, 3e2], marker='None', ls='-', color='black')
ax2.plot([-0.49, -0.49], [2e2, 3e2], marker='None', ls='-', color='black')
ax2.plot([0.49/2, 0.49/2], [2e2, 3e2], marker='None', ls='-', color='black')
ax2.plot([-0.49/2, -0.49/2], [2e2, 3e2], marker='None', ls='-', color='black')
...
ax2.errorbar(qy_sat*10, I_sat, sI_sat, label='$I$', elinewidth=1, capsize=0, linewidth=1)
ax2.set_yscale('log')
