...
qy_sat_p, qz_sat_p, data_sat_p, I_sat_p, sI_sat_p = load_files('./0rawdata/020', np.arange(673, 684, 2))
qy_sat_m, qz_sat_m, data_sat_m, I_sat_m, sI_sat_m = load_files('./0rawdata/020', np.arange(674, 684, 2))
...
txt = ax.text(0.01, 0.01,\
        "$\mathit{T}\, =\, 250 \,K$\n$\mu_0 \mathit{H} \,=\, 4\, T$\n$"+r"\mathit{\vec{H}} \mathrm{\parallel} \mathit{\vec{k}}"+"$",\
        color='white',\
        horizontalalignment='left',
...
fig.savefig('Gisans175_28_parallelBeam.png')
# plt.show()
