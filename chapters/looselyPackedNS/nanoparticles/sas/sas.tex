...
\begin{document}
  ...
  \paragraphNewLine{Determination of Particle Sizes And Core-Shell Structure with SAS}
    ...
    Furthermore the SLD of oleic acid and the solvents, cyclohexane for SAXS and toluene-$\mathit{d8}$ for SANS respectively, are fixed to the values tabulated in \refapp{appendix:slds}.
