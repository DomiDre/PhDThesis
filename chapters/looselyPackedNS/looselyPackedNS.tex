...
Magnetite/Maghemite ($\ch{Fe3O4}$ , $\gamma - \ch{Fe2O3}$) is a common choice for the study of nanomagnetism as it shows strong ferromagnetism and is widely available.
...
Small-angle x-ray scattering experiments were performed on both samples at the \textsc{GALAXI} instrument in the \textsc{Forschungszentrum J\"ulich}, which is described in \refapp{ch:appendix:lss:galaxi}.
