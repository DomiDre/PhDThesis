...
\begin{document}
  ...
  \begin{table}[tb]
    \centering
    \caption{\label{tab:looselyPackedNP:nanoparticle:gisaxs}Parameters for the hard-sphere structure factor in Percus-Yervick approximation shown in \reffig{fig:looselyPackedNP:layer:gisaxsSC_IOS_11} and \reffig{fig:looselyPackedNP:layer:gisaxsSC_IOS_7} for both SC-IOS-11 and SC-IOS-7 respectively. $R_\mathrm{HS}$ is the hard-sphere radius and $\eta$ the packing fraction of the structure factor. Using both values the Wigner-Seitz radius $\bar{r}$ is determined, as well as the average radius of equivalent spheres in a close packing $\bar{r}_\mathrm{CP}$.}
    \begin{tabular}{ c | l | l }
