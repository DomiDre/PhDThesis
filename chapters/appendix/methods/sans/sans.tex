...
\begin{document}
  \section{Small-Angle Neutron Scattering (SANS)}
    ...
    The data acquisition in small-angle neutron scattering experiment is in many ways parallel to the SAXS experiment described in \refapp{app:methods:saxs}.
    The SANS experiments of this thesis have all been performed on ILL beamlines, either at D22 \refapp{ch:appendix:lss:d22} or D33 \refapp{ch:appendix:lss:d33}, where for the data reduction the MATLAB script GRASP \cite{Dewhurst_2003_Grasp} is used.
    ...
    \begin{figure}[tb]
      ...
      \caption{\label{fig:appendix:methods:sans:sanspolData}For the evaluation of the magnetic scattering, a cake of $\pm 10^\circ$ is azimuthally integrated along the axis that is perpendicular to the magnetic field (area between black lines).}
    \end{figure}
    ...
    In this thesis, typically a small cake slice of $\pm 10^\circ$ around the vertical axis, as depicted in \reffig{fig:appendix:methods:sans:sanspolData}, is azimuthally integrated to obtain $I^\pm$.
    ...
    \begin{figure}[tb]
      ...
      \caption{\label{fig:appendix:methods:sans:resolution}Depiction of the angular divergence of the direct beam due to finite collimation and sample aperture size.}
    \end{figure}
    ...
    The first addend can be understood by considering the beam spot due to collimation for $w_\mathrm{s} \eq 0$, as shown in red in \reffig{fig:appendix:methods:sans:resolution}, and the second addend by considering conversely $w_\mathrm{c} \eq 0$, as shown in blue.
