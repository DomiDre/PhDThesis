...
\begin{document}
  \section{SAXS}
    ...
    To measure multiple samples over the course of a day automatically within the same setup, the capillaries are placed in a sample holder that can hold up to 11 capillaries, which is shown in \reffig{fig:appendix:methods:saxs:samples}.
    ...
    Thus, by doing the azimuthal integration of the detector data, as shown in \reffig{fig:appendix:methods:saxs:agBH}, both the beam center and the sample-to-detector distance can be determined quickly.
    ...
    \end{figure}
    Typically, a profile such as shown in \reffig{fig:appendix:methods:saxs:fep_scan} on the right is obtained.
