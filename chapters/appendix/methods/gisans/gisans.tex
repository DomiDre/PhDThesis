...
\begin{document}
  \section{Grazing-Incidence Small-Angle Neutron Scattering (GISANS)}
    ...
    For this purpose the sample is typically mounted on a screwable aluminium holder as shown in \reffig{appendix_methods_gisans_sample}, such that it can be fixed on a rod and lowered into a cryo-magnet.
