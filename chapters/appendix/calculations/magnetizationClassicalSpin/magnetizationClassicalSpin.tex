...
As discussed in \refch{ch:theoreticalBackground:magnetism:paramagnetism}, a single spin exposed to an external magnetic field $B$ and feels a torque to minimize the Zeeman energy
\begin{align}
