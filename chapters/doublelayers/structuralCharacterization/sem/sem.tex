...
\begin{document}
  ...
  \begin{figure}[tb]
    \centering
    \includegraphics{doubleLayers_SEMxs_DL-0_125} %[width=0.48\textwidth]
    \includegraphics{doubleLayers_SEMxs_DL-0_25} %[width=0.48\textwidth]
    \includegraphics{doubleLayers_SEMxs_DL-1_25} %[width=0.48\textwidth]
    \includegraphics{doubleLayers_SEMxs_DL-2_5} %[width=0.48\textwidth]
    \includegraphics{doubleLayers_SEMxs_DL-5} %[width=0.48\textwidth]
