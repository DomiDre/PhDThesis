...
\begin{document}
  ...
  On the prepared monolayers, $80 \unit{\musf L}$ of the dispersions with PMMA concentrations tabulated in \reftab{tab:doubleLayers:preparation:samples} are dropped equally distributed on the surface of the sample and spin coated at $33 \unit{rps}$ for $60 \unit{s}$.
