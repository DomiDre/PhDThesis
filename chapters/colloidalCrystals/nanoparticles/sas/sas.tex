...
\begin{document}
  ...
  The SAXS data that was measured at the GALAXI instrument (\refch{ch:lss:galaxi}) and the SANS data measured at D33 (\refch{ch:lss:d33}) are shown after data reduction in \reffig{fig:colloidalCrystals:nanoparticle:sas}.
  ...
  The best fits are respectively shown in \reffig{fig:colloidalCrystals:nanoparticle:sas} with the scattering length density profile in each case shown in the insets of the figures.
  ...
  Furthermore a size distribution of $7.53 \%$ is observed, which is determined by SAXS and confirmed from the SANS fit.
  ...
  \begin{table}[!htbp]
    ...
    \begin{tabular}{ c | l | l}
      ...
      \rule{0pt}{2ex} $D_\mathrm{shell}\, / \unit{nm}$                    & $5.48(2)$    & $3.6(2)$       \\
      \rule{0pt}{2ex} $D_\mathrm{surfactant}\, / \unit{nm}$               & -            & $1.41$         \\
      \rule{0pt}{2ex} $p $                                                & \multicolumn{2}{c}{$2.18$} \\
      \rule{0pt}{2ex} $\sigma_{(R+D)}\, / \unit{\%}$                      & \multicolumn{2}{c}{$7.53$} \\
      \rule{0pt}{2ex} $n \, / \unit{10^{-8} \angstrom^{-3}}$              & $0.0297(1)$  &  $0.056(1)$ \\
      \hline
      ...
      \rule{0pt}{2ex} $\Delta \theta_\mathrm{11 m} \, / \unit{mrad}$                  & -       & $1.5(1)$\\
      \rule{0pt}{2ex} $\Delta \theta_\mathrm{2 m} \, / \unit{mrad}$                   & -       & $2.7(2)$\\
  ...
  \paragraphNewLine{Magnetic Structure}
    ...
    The magnetic SLD of the core corresponds to a magnetization of $ \unit{kA \, m^{-1}}$ and the SLD of the shell to $ \unit{kA \, m^{-1}}$.
    ...
    The volume weighted average of the magnetization of the nanocubes is given by $ \unit{kA \, m^{-1}}$.
    ...
    \begin{table}[!htbp]
      ...
      \begin{tabular}{ c | l }
        ...
        \hline
        \rule{0pt}{2ex} $\rho^\mathrm{mag}_\textsf{w\"ustite} \, / \unit{10^{-6} \angstrom^{-2}}$ & $0.92116()$ \\
        \rule{0pt}{2ex} $\rho^\mathrm{mag}_\mathrm{magnetite} \, / \unit{10^{-6} \angstrom^{-2}}$ & $1.1413()$ \\
        \hline
        \rule{0pt}{2ex} $M_\textsf{w\"ustite} \, / \unit{kA m^{-1}}$      & $317()$ \\
        \rule{0pt}{2ex} $M_\mathrm{magnetite} \, / \unit{kA m^{-1}}$      & $392()$ \\
        \hline
        \rule{0pt}{2ex} $\bar{M}_\mathrm{particle} \, / \unit{kA m^{-1}}$ & $387()$ \\
        \hline
      \end{tabular}
    \end{table}
