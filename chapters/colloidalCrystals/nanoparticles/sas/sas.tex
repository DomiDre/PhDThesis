...
\begin{document}
  ...
  The superball radius corresponds to a superball edge length of $12.26(4) \unit{nm}$ and the superball exponent to a cube with rounded edges visualized in the inset of \reffig{fig:colloidalCrystals:nanoparticle:sas}.
