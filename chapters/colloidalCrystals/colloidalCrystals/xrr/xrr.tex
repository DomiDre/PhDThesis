...
\begin{document}
  ...
  Comparing this with the expectation for the ($bct$) structure with [101] orientation as it is depicted in \reffig{fig:colloidalCrystals:layers:gisaxsBCTUCDepiction}, a ratio above $2$ would be expected due to an additional interparticle spacing.
