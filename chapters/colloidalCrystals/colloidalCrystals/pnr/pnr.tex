...
\begin{document}
  ...
  In the reflectivities, minima can be observed at $0.34(2) \unit{nm^{-1}}$ and $0.74(2) \unit{nm^{-1}}$, which corresponds with $2 \pi / \Delta q \approx 16(1) \unit{nm}$ to a similar length scale as observed for XRR in \refsec{sec:colloidalCrystals:layers:xrr}.
