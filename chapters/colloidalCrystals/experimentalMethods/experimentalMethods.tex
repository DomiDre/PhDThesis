...
\begin{document}
  ...
  The labels of the prepared samples are summarized in \reftab{tab:colloidalCrystals:expMethods:samples} and the methods for the nanoparticle synthesis and colloidal crystal growth, as well as the characterization methods applied for both are described in the following.
  \begin{table}[!htbp]
    \centering
