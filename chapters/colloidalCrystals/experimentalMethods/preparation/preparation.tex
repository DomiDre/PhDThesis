...
\begin{document}
  ...
  The beakers, shown in \reffig{fig:colloidalCrystals:preparation:image} are placed in a fume hood of a low-vibration room and allowed to evaporate without interference over a course of $2 - 3 \unit{days}$ until the solvent and the wafer surface has completely dried.
\end{document}