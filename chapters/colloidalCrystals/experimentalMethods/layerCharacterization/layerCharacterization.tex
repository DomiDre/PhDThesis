...
\begin{document}
  ...
  \paragraphNewLine{X-Ray Reflectometry}
    ...
    Additionally, the data is corrected for diffuse scattering around the specular peak, by integrating boxes in the range $\alpha_i - \alpha_o \eq \pm (0.1 - 0.2)$, and subtracting the diffuse scattering intensity from the specular intensity.
