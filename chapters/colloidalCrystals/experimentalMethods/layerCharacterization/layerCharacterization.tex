...
\begin{document}
  ...
  \paragraphNewLine{Grazing-Incidence Small-Angle X-ray Scattering}
    ...
    The sample was measured at the incident angles of $0.125 ^\circ$ and $0.175 ^\circ$ with a wavelength of $\lambda \eq 1.341 \unit{\angstrom}$.
    ...
    The obtained detector image is discussed qualitatively by performing a horizontal cut along the Yoneda line and vertical cuts along the observed peak positions.
  ...
  \paragraphNewLine{Vibrating Sample Magnetometry}
    ...
    Each sample is broken to a size of approximately $5 \times 5 \unit{mm^2}$ using a diamond cutter and stuck to a Quartz sample holder using a low temperature varnish (GE 7031).
