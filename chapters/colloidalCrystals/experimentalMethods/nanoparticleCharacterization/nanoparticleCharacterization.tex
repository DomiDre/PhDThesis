...
\begin{document}
  \paragraphNewLine{Transmission Electron Microscopy}
    The as-synthesized iron oxide nanocubes are investigated by transmission electron microscopy using a Zeiss Leo 902 (\refsec{ch:instruments:laboratoryInstruments:tem}).
  ...
  \paragraphNewLine{Small-Angle Scattering}
    ...
    The SAXS measurement was performed eight months after the synthesis at GALAXI (\refsec{ch:lss:galaxi}), where the nanoparticles were dispersed in toluene and filled in borosilicate capillaries (Hilgenberg) with $1.5 \unit{mm}$ diameter and a $0.01 \unit{mm}$ wall thickness.
    ...
    For SANS and SANSPOL, the D33 instrument (\refsec{ch:lss:d33}) has been utilized three months after the synthesis.
