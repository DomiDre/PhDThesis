...
\begin{document}
  \subsection{Scattering Theory}\label{sec:theoreticalBackground:scattering:scatteringTheory}
    ...
    \end{align}
    is known as the Born approximation and is the starting point for many further calculations.
    It fully describes the case where the wave undergoes only a single scattering event as it passes through the sample.
