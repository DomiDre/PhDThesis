...
In \refapp{ch:appendix:calculations:scatteringTheoryElectromagneticWaves} scattering theory is derived from classical electrodynamics resulting in the result that the differential cross section is given by
\begin{align}
