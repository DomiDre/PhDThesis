...
\begin{document}
  ...
  \end{figure}
  Three of the most common iron oxide structures are depicted in \reffig{fig:theoreticalBackground:ferrites:ironOxides}.
  When both $\ch{Fe^{2+}}$ and $\ch{Fe^{3+}}$ are present, magnetite (\ch{Fe3O4}) forms as the stable phase with the structure of an inverse spinel in the space group $Fd\bar{3}m$ and a lattice constant of $a \eq 8.396 \unit{\angstrom}$ \cite{Cornell_2003_Their}.
