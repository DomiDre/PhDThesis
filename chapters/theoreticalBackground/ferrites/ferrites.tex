...
\begin{document}
  ...
  In the common iron oxides in nature, the oxygen anions \ch{O^{2-}} form a close packed lattice with octahedral and tetrahedral interstices, where the iron cations position as shown in \reffig{fig:theoreticalBackground:ferrites:ironOxides}.
  \begin{figure}[b]
    \centering
