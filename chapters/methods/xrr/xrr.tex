...
\begin{document}
  \section{X-Ray Reflectometry (XRR)}
    ...
    Then to improve this alignment, $\alpha_i$ and $\alpha_o$ is set to some angle still close to the critical angle such as $0.3^\circ$ and another rocking scan is performed  (\reffig{fig:methods:xrr:alignment}, right).
