...
\begin{document}
  \section{Grazing-Incidence Small-Angle Neutron Scattering (GISANS)}
    ...
    The sample is typically mounted on a screwable aluminum holder as shown in \reffig{fig:methods:gisans:samples}, such that it can be fixed on a rod and lowered into the cryomagnet.
