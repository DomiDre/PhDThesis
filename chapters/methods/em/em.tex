...
\begin{document}
  \section{Electron Microscopy (EM)}
    ...
    \paragraph{Energy-Dispersive X-ray Spectroscopy (EDX)}
      ...
      A caveat is that EDX is typically not reliable in the detection of elements with small atomic numbers below that of \ch{Na}, meaning it can not be used to quantify the amount of oxygen or carbon in a sample.
\end{document}