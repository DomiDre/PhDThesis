...
\begin{document}
  \section{Neutron Reflectometry (NR)}
    ...
    The PNR experiments presented in this thesis were performed at the ILL beamlines SuperADAM (\refch{ch:lss:superadam}) and D17 (\refch{ch:lss:d17}), as well as the MLZ beamline MARIA (\refch{ch:lss:maria}), which all measure the reflected neutron beam on a position-sensitive detector.
