...
\begin{document}
  \section{Small-Angle Neutron Scattering (SANS)}
    ...
    The data acquisition in small-angle neutron scattering experiment is in many ways parallel to the SAXS experiment described in \refsec{ch:methods:saxs}.
    The SANS experiments of this thesis have all been performed on ILL beamlines, either at D22 (\refsec{ch:lss:d22}) or D33 (\refsec{ch:lss:d33}).
