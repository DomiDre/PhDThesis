...
\begin{document}
  \subsection{D33}\label{ch:lss:d33}
    ...
    \end{figure}
    The D33 instrument \cite{\cite{Dewhurst_2015_Thesm}} at the Institut Laue-Langevin is used to measure small-angle scattering of polarised neutrons for dispersions, as well as for samples on a substrate under grazing-incidence.
