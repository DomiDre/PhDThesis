...
\section{Laboratory Instruments}
  ...
  \subsection{X'Pert PRO - XRD}
    ...
    \subsection{Zeiss LEO 902 - TEM}
      ...
      Transmission electron microscopy was used using a Zeiss Leo 902 microscope operating at $120 \unit{kV}$ with a \ch{LaB6} cathode in bright field mode to obtain high-magnification micrographs of single nanoparticles.
