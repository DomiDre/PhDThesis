...
\section{Laboratory Instruments}
  \subsection{PPMS Evercool II - VSM}
    ...
    The installed Evercool II has the option to choose between VSM (\refsec{ch:methods:vsm}) and AC-Susceptometry, where the latter was not utilized in the scope of this thesis.
  ...
  \subsection{D8 Advanced - XRR}
    ...
    \end{figure}
    To perform XRR experiments, described in \refsec{ch:methods:xrr}, a D8 Advanced instrument from the company Bruker was used at the \textsc{Forschungszentrum J\"ulich}.
  ...
  \subsection{X'Pert PRO - XRD}
    ...
    XRD measurements (\refsec{ch:methods:xrd}) were performed by a collaboration with the group of Daniel Nižňanský from the Department of Inorganic Chemistry at the Charles University in Prague.
