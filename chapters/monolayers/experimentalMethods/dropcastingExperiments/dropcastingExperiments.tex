...
\begin{document}
  ...
  \paragraphNewLine{Determination of Nanoparticle Concentration}
    ...
    \paragraphNewLine{Variation of Alkanes / Alkenes as Solvent / Co-Solvent}
      ...
      \end{align}
      where the FWHM of the peak is corrected for $\Delta q_{D.B.} \eq 0.0195(7) \unit{nm^{-1}}$, the FWHM of the direct beam given for GALAXI in \reffig{fig:appendix:lss:galaxi:directBeam}.
