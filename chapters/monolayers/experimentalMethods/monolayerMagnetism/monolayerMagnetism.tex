...
\begin{document}
  ...
  \paragraphNewLine{Polarized Neutron Reflectometry}
    ...
    Additional to the measurement at guide field after zero-field cooling, described in \refsec{sec:monolayers:monolayerCharacterization}, the sample was measured afterwards at a saturating field of $6 \unit{T}$ and a negative field of $-100 \unit{mT}$.
