...
\begin{document}
  ...
  \paragraphNewLine{Reflectometry}
    ...
    A $q$-range of $0 - 0.4 \unit{\angstrom^{-1}}$ has been measured by using the equipped Cu-K$\alpha$ source ($\lambda \eq 1.54 \unit{\angstrom}$) and measuring a range of the scattering angle $2 \theta \eq 0 - 3 \unit{^\circ}$ in $0.005 \unit{^\circ}$ steps over an integrated time of approximately $1 \unit{h}$.
