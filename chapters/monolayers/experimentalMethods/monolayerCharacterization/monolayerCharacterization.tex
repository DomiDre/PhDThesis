...
\begin{document}
  ...
  \paragraphNewLine{Vibrating Sample Magnetometry}
    ...
    The sample was measured on a PPMS system at the \textsc{Forschungszentrum J\"ulich}, which operates analogue to the EverCool II system shown in \refsec{ch:instruments:laboratoryInstruments:vsm} only that it does not have a closed Helium cycle and produces a maximum field of $7 \unit{T}$.
