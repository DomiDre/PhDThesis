...
\begin{document}
  ...
  The values are used in the BornAgain software package \cite{Burle_2018_borna}, to simulate the two dimensional GISAXS data nanocubes with a paracrystalline square lattice interference function shown in the right plot of \reffig{fig:monolayers:structure:ML-Ac-CoFe-C-2:GISAXS} and the parameters tabulated in \reftab{tab:monolayers:structure:squareArrayParacrystal:BornAgainSimulation}.
  ...
  \begin{table}[!htbp]
    \centering
    \caption{\label{tab:monolayers:structure:squareArrayParacrystal:BornAgainSimulation}Fitted parameters of the simulated nanocubes in a paracrystalline square lattice shown in \reffig{fig:monolayers:structure:ML-Ac-CoFe-C-2:GISAXS}. }
    \begin{tabular}{l | c}
      \hline
