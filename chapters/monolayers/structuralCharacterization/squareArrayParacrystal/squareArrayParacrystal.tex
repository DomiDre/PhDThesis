...
\begin{document}
  ...
  \begin{table}[!htbp]
    \centering
    \caption{\label{tab:monolayers:structure:squareArrayParacrystal:BornAgainSimulation}Fitted parameters of the simulated nanocubes in a paracrystalline square lattice shown in \reffig{fig:monolayers:structure:BornAgainParacrystal}. }
    \begin{tabular}{l | c}
      \hline
