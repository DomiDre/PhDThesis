...
\begin{document}
  ...
  \subsubsection{Alkanes / Alkenes as Solvent / Co-Solvent}
    ...
    A close inspection of the reflection positions and width in \reftab{tab:monolayers:solventProperties:GisaxsLatticeParams} shows that for increasing order of alkane, the lattice constant reduces and the coherence length increases.
