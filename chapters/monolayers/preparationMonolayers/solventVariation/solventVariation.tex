...
\begin{document}
  ...
  \subsubsection{Alkanes / Alkenes as Solvent / Co-Solvent}
    ...
    The first order reflection of the structured monolayers is fit by a Lorentzian function to determine it's center position  $q_{10}$ and it's reflection width $\gamma_{10}$, which both are tabulated in \reftab{tab:monolayers:solventProperties:GisaxsLatticeParams}.
    ...
    A close inspection of the reflection positions and width in \reftab{tab:monolayers:solventProperties:GisaxsLatticeParams} shows that for increasing order of the alkane, the lattice constant reduces and the coherence length increases.
