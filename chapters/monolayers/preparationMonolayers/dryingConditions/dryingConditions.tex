...
\begin{document}
  ...
  \subsubsection{First Stage: Fast Evaporating Component}
    ...
    \end{figure}
    Applying an in-plane magnetic field to strongly magnetic nanocubes during the first drying stages by the means of an Halbach cylinder, shown in the right image of \reffig{fig:monolayers:preparation:dryingConditions:varyConditions}, leads to a qualitative reduction of lattice defects and a tendency of aligning the cubes with the (100) faces along the magnetic field, which is visible in the SEM micrographs shown in \reffig{fig:monolayers:preparation:dryingConditions:magneticField}.
  ...
  \subsubsection{Second Stage: Slow Evaporating Components}
    ...
    After the fast evaporating component of the dispersion has dried, a thin oily film is visible on the wafer by thin-film interference, shown in \reffig{fig:monolayers:preparation:dryingConditions:oilyFilm}.
