...
\begin{document}
  ...
  % The basic idea is to use a mixture of a fast-evaporating solvent, such as \textit{n}-heptane, as primary dispersion medium and a slow-evaporating solvent, such as 1-octadecene, as additive.
