...
\begin{document}
  ...
  In their kinetic theory depicted in \reffig{fig:monolayers:preparation:dryingConditions:dryingStages}, they reduce the crucial ingredients for long-range ordered monolayers from drop casting to two parameters, the flux of particles to the droplet surface and the diffusion length on the liquid-air interface.
