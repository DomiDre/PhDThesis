...
\begin{document}
  ...
  \end{figure}
  The reflectivities under an applied in-plane magnetic field $\vec{B}_\mathrm{ext.}$ of ML-Ac-CoFe-C for incident neutrons with the RF flipper turned off $R^{+}$ and with the flipper turned on $R^{-}$ are shown in \reffig{fig:monolayer:magneticStructure:pnr5K}.
