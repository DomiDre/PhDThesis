...
\begin{document}
  ...
  \label{sec:monolayers:nanoparticle:structuralCharacterization}
    ...
    \begin{figure}[tb]
      ...
      \caption{\label{fig:monolayers:nanoparticle:vsm}Roomtemperature hysteresis measurement of Ol-CoFe-C (upper left) and Ac-CoFe-C (lower left) taken on a vibrating sample magnetometer fitted with a Langevin curve.}
    \end{figure}
