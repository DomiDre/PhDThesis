...
\begin{document}
  ...
  \label{sec:monolayers:nanoparticle:structuralCharacterization}
    ...
    \begin{figure}[tb]
      ...
      \includegraphics{monolayer_VSM_10K_Ac_CoFe_C}
      \caption{\label{fig:monolayers:nanoparticle:vsm10K}Low temperature hysteresis measurement of frozen Ol-CoFe-C (upper left) and Ac-CoFe-C (lower left) using the same samples as in \reffig{fig:monolayers:nanoparticle:vsm}.}
    \end{figure}
    ...
    And indeed, including a w\"ustite phase in the Rietveld refinement greatly improves the model as shown in \reffig{fig:monolayers:nanoparticle:xrdWustite}.
