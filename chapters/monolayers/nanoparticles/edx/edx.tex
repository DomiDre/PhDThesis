...
\begin{document}
  ...
  As XRD in \refsec{sec:monolayers:nanoparticle:xrd} however suggests $97 \%$ of the nanoparticle is in a wustite phase.
  Thus in a first approximation the ratio can be used to determine the relative composition of iron and cobalt in the wustite phase, which yields \ch{Fe_{0.71} Co_{0.29} O}.
