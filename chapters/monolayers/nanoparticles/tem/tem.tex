...
\begin{document}
  ...
  \begin{figure}[tb]
    ...
    \includegraphics{monolayers_TEM_Ol_Fe_C_ML}
    \includegraphics{monolayers_TEM_Ol_Fe_C_ML_sizeDist}
    \includegraphics{monolayers_TEM_Ol_CoFe_S}
    \includegraphics{monolayers_TEM_Ol_CoFe_S_sizeDist}
