...
\begin{document}
  ...
  The resulting parameters of the LeBail fits, including the lattice constants $a$ and the Lorentzian broadening $Y$ of the peaks are listed for all four LeBail fits in \reftab{tab:monolayers:nanoparticle:discussion:xrdLeBail}.
  ...
  \paragraphNewLine{Lattice constant}
    ...
    % In this case, the lattice constant of the w\"ustite core is larger in comparison to the w\"ustite phase of the nanospheres in \refch{ch:looselyPackedNS}, where it was $4.1819 \unit{\angstrom}$, but smaller than the lattice constant of $4.265 \unit{\angstrom}$ observed by Wetterskog \etal \cite{Wetterskog_2013_Anoma} for as-synthesized 
    % But 
