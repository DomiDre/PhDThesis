...
\begin{document}
  ...
  The macroscopic field-dependent magnetization of the Ac-CoFe-C nanocubes was measured in an \textit{n}-hexane dispersion, as well as in a dry state after evaporation from \textit{n}-hexane without additives and is shown in \reffig{fig:monolayers:nanoparticle:vsmAcCoFeC}.
  ...
  Using the nanocube size characterization from small-angle X-ray scattering in \refsec{sec:monolayers:nanoparticle:sas}, the spontaneous magnetization is estimated by the nanocube volume to $M_s \eq 298(1) \unit{kA\, m^{-1}}$.
  This is in comparable order of magnitude as the magnetization determined by SANSPOL $334(5) \unit{kA \, m^{-1}}$ (\refsec{sec:monolayers:nanoparticle:sas}).
  ...
  From the particle concentration determined by small-angle X-ray scattering in \refsec{sec:monolayers:nanoparticle:sas}, the average interparticle spacing in dispersion can be estimated to $160 \unit{nm}$ from the Wigner-Seitz radius.
  ...
  Using the nanocubes in the dry state, shown in \reffig{fig:monolayers:nanoparticle:vsm10K} (left), the blocking temperature is found at a high temperature of $315 \unit{K}$.
  ...
  This stronger magnetization is also observed in SANSPOL (\refsec{sec:monolayers:nanoparticle:sas}), where a particle magnetization of $444(3) \unit{kA \, m^{-1}}$ is determined for Ac-CoFe-C-2.
  ...
  The magnetization at $1.2 \unit{T}$ of $100 \unit{kA \, m^{-1}}$ corresponds closely to the observed particle magnetization of $113(12)\unit{kA \, m^{-1}}$ in SANSPOL (\refsec{sec:monolayers:nanoparticle:sas}).
  ...
  \begin{figure}[tb]
    \centering
    \includegraphics{monolayer_PPMS_ZFC_FC_Ac_CoFe_C}
    \includegraphics{monolayer_PPMS_ZFC_FC_Ol_CoFe_C}
